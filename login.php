...
<h1>Cadastro</h1>
	  ...
	  <div class="login">
		<form id="form" method="POST" action="model/v_cadPac.php">
			<div id="formulario">
        		</br></br>
        		<form method="POST" action="model/v_cadPac.php">
				...
				<a href="login2.php" style="margin-bottom:5vh;">Médico, Clique Aqui</a><br>
