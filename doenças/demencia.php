...
<div class="bloco" id="cont">
  ...
  <p class="p"> 
  A Demência Vascular (DV) compreende um declínio cognitivo global, atribuível ao efeito cumulativo das doenças vasculares cerebrais. Como resultado dos danos cerebrovasculares focais, são sucessivamente perdidas as sutis múltiplas habilidades cognitivas, inclusive, memória.  </p>
...
<p class="p">
Os principais fatores de risco observados foram história de doença cerebrovascular e hipertensão arterial. Depressão, distúrbios do sono, sinais neurológicos focais e pseudobulbares foram os achados clínicos mais frequentes.   
</p>
...
<p class="p">
Os sintomas de demência vascular (perda de memória, dificuldade de planejamento e iniciar ações ou tarefas, raciocínio lento, e uma tendência a vagar) são semelhantes aos de outras demências. 
</p>
...
<p class="p">
Não há tratamento específico para a demência vascular. O tratamento é feito por meio de terapia e do uso de medicamentos que melhoram a cognição.</p>
</div>
